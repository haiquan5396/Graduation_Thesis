...
docker run -itd --name cloud-to-fog -e "BROKER_CLOUD=$BROKER_CLOUD" -e "BROKER_FOG=$BROKER_FOG" haiquan5396/forwarder_cloud_to_fog:1.0
...
docker run -itd --name collector -e "BROKER_CLOUD=$BROKER_CLOUD" -e "MODE=$MODE" haiquan5396/collector:1.0
